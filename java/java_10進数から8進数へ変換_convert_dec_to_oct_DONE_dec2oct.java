...
public class java_10進数から8進数へ変換_convert_dec_to_oct_DONE_dec2oct {
    ...
    private static void dec2oct(String str) {
        System.out.println(Integer.toOctalString(Integer.valueOf(str)));
    }
}