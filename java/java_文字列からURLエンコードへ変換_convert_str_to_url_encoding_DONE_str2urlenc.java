...
public class java_文字列からURLエンコードへ変換_convert_str_to_url_encoding_DONE_str2urlenc {
    ...
    private static void usage() {
        ...
        System.out.println("\nUsage:\n" +
            "cat test.tsv.done | "+ className.replaceAll(".*_", "") +" | sed '/^$/d' | xargs -n$(cat test.tsv.done|awk 'END{print NF}') \n" +
    ...
    private static void str2urlenc(String str) throws UnsupportedEncodingException {
        System.out.println(URLEncoder.encode(str, encoding));
    }
}