...
public class App {
    ...
    private static void usage() {
        ...
        System.out.println("\n" +
                ...
                "z zh-CN zh-TW\n" +
                "\n" +
                "CMD: echo ja 10 | java -jar /home/aine/script-sketch/java/00011-java-fakerでダミーデータ作成/nnn/target/TOBE_REPLACE_APP_NAME-1.0-SNAPSHOT-jar-with-dependencies.jar" +
                "\n");
        System.exit(0);
    }
