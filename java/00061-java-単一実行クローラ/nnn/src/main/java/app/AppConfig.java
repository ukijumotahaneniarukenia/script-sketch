...
public class AppConfig {
    ...
    private static final String CSS_SELECTOR_MAP = "CSS_SELECTOR_MAP";
    ...
    private Map<String,String> cssSelectorMap = new HashMap<>();
    private Map<String,String> ignoreSuffixMap = new HashMap<>();
    private Map<String,String> cacheDirMap = new HashMap<>();

    public AppConfig(String baseUrl,String cssSelector,String ignoreSuffix,String cacheDir){
        baseUrlMap.put(BASE_URL_MAP,baseUrl);
        cssSelectorMap.put(CSS_SELECTOR_MAP,cssSelector);
    ...
    public String getCssSelector() {
        return cssSelectorMap.get(CSS_SELECTOR_MAP);
    }
