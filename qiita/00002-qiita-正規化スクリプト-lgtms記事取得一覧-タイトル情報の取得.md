...
```
$cat a.json | jq -c 'select(.key|(test("title")))|{grp:.key|gsub(".*items-";"")|gsub("-.+";""),subgrp:(if "user"==(.key|gsub(".*tags-";"")|gsub("-.+";"")) then "0" else . end),label:.key|gsub(".*-";""),value:.value}'
```

- OUT

```
{"grp":"29","subgrp":"0","label":"title","value":"お前Rは初めてか？力抜けよ"}
{"grp":"30","subgrp":"0","label":"title","value":"Rの型について理解する"}
{"grp":"31","subgrp":"0","label":"title","value":"R のモダンな NA 処理まとめ"}
{"grp":"32","subgrp":"0","label":"title","value":"JavaScript ベスト・オブ・ザ・イヤー 2019"}
```
