...
- CMD
  ...
  - nth-childのエイリアス
```
cat test-big.html | pup '.cpd-l' | pup ':nth-of-type(1)'
```
...
```
cat test-big.html | pup '.cpd-l' | pup ':nth-of-type(2)'
```
...
```
cat test-big.html | pup '.cpd-l' | pup ':nth-of-type(6)'
```
...
```
cat test-big.html | pup '.cpd-l' | pup ':nth-of-type(7)'
```
